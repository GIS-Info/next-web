...
export default {
    ...
    computed: {
        groupedUniversities() {
            const groups = {};
            this.universities.filter(university => university.Continent === '南美洲').forEach(university => {
        ...
        filteredUniversities() {
            ...
            return this.universities.filter(
                university => university.City_Name_CN === this.selectedCity && university.Continent === '南美洲'
            );
        },
    },
