...
export default {
    ...
    computed: {
        groupedUniversities() {
            const groups = {};
            this.universities.filter(university => university.Continent === '大洋洲').forEach(university => {
        ...
        filteredUniversities() {
            ...
            return this.universities.filter(
                university => university.City_Name_CN === this.selectedCity && university.Continent === '大洋洲'
            );
        },
    },
